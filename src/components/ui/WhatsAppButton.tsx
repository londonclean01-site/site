  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-center">
      ...
      <motion.a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#4A90D9] hover:bg-[#357ABD] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
